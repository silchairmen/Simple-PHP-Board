...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // 입력값 받기
    $title = str_replace("script", "nohack", $title);
    $content = str_replace("script", "nohack", $content);
    $title = str_replace("img", "nohack", $title);
    $content = str_replace("img", "nohack", $content);
